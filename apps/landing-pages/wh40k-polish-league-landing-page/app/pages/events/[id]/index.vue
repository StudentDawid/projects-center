        ...
        <v-container class="px-4 pb-16 pt-0" style="max-width: 1100px">
          ...
          <div>
            <div>
              ...
              <v-card
                class="bg-surface rounded-xl border border-opacity-100 mb-12"
                elevation="0"
              ...
              >
                <v-row no-gutters>
                  ...
                  <v-col
                    cols="12"
                    md="6"
                    class="pa-8 pa-md-10 border-b border-md-b-0 border-md-r border-opacity-100"
                    style="border-color: #f3f4f6 !important"
                  >
                  ...
                  <v-col
                    cols="12"
                    md="6"
                    class="pa-6 pa-md-10 d-flex flex-column align-center justify-center text-center"
                  >
                    <!-- Countdown -->
                    <div
                      class="d-flex justify-center mb-6 w-100 px-2 px-sm-4"
              ...
              <v-row spacing="48">
                ...
                <v-col cols="12" md="4" class="pr-md-6">
                  ...
                  <div class="mb-10">
                    <div class="d-flex align-center mb-6">
                      ...
                      <h2 class="text-h6 font-weight-bold mb-0">
                        {{ $t('event_page.location_title') }}
                      </h2>
                    </div>
                    <v-card
                      class="border border-opacity-100 rounded-xl pa-6"
                      elevation="0"
                      style="border-color: #f3f4f6 !important"
                    >
                      <h3 class="text-subtitle-1 font-weight-bold mb-2">
                        {{
                          ...
                          $t('event_page.location_name')
                        }}
                      </h3>
                      <p class="text-body-2 text-text-muted mb-6">
                        {{
                          currentEvent?.location_address ||
                          $t('event_page.location_address_1')
                        }}
                      </p>
                      <!-- Map Placeholder -->
                      <div
                        class="bg-background rounded-lg d-flex flex-column align-center justify-center py-16 px-4 text-center border border-opacity-100"
                        style="
                      ...
                      >
                        <v-icon
                          ...
                          size="32"
                          color="text-muted"
                          class="mb-3 opacity-60"
                        />
                        <span
                          class="text-caption font-weight-bold text-text-muted"
                          style="letter-spacing: 1px"
                          >{{ $t('event_page.view_map') }}</span
                        >
                      </div>
                    </v-card>
                  </div>
                  ...
                  <div>
                    <div class="d-flex align-center mb-6">
                      ...
                      <h2 class="text-h6 font-weight-bold mb-0">
                        {{ $t('event_page.docs_title') }}
                      </h2>
                    </div>
                    <v-card
                      class="bg-surface rounded-lg pa-4 d-flex align-center border border-opacity-100"
                      elevation="0"
                      style="border-color: #f3f4f6 !important"
                    >
                      <v-icon
                      ...
                      <div class="flex-grow-1">
                        <div class="text-subtitle-2 font-weight-bold">
                          {{ $t('event_page.doc_name') }}
                        </div>
                        <div class="text-caption text-text-muted">
                          {{ $t('event_page.doc_desc') }}
                        </div>
                      </div>
                      <v-btn
                        icon="mdi-download"
                ...
                <v-col cols="12" md="8">
                  <div class="d-flex align-center mb-6">
                    ...
                    />
                    <h2 class="text-h6 font-weight-bold mb-0">
                      {{ $t('event_page.schedule_title') }}
                    </h2>
                  </div>

                  <v-card
                    class="border border-opacity-100 rounded-xl overflow-hidden"
                    elevation="0"
                    style="border-color: #f3f4f6 !important"
                  >
                    <!-- Day 1 -->
                    <div
                      class="bg-background-light px-6 py-4 d-flex justify-space-between align-center border-b border-opacity-100"
                    ...
                    >
                      ...
                      <span class="text-caption text-text-muted">{{
                        $t('event_page.date_day1')
                      }}</span>
                    </div>
                    <v-list class="pa-0">
                      <v-list-item
                        class="px-6 py-4 border-b border-opacity-100"
                        style="border-color: #f3f4f6 !important"
                      >
                        <v-row no-gutters align="center">
                          ...
                          <v-col
                            ...
                            >{{ $t('event_page.registration_briefing') }}</v-col
                          >
                        </v-row>
                      </v-list-item>
                      <v-list-item
                      ...
                      >
                        <v-row no-gutters>
                          <v-col
                            cols="4"
                            sm="3"
                            class="text-body-2 font-weight-bold text-primary py-1"
                            >09:30 - 12:30</v-col
                          >
                          <v-col cols="8" sm="9">
                            ...
                            <div class="text-caption text-text-muted">
                              {{ $t('event_page.mission1') }}
                            </div>
                          </v-col>
                        </v-row>
                      </v-list-item>
                      <v-list-item
                        class="px-6 py-4 border-b border-opacity-100 bg-background"
                        style="border-color: #f3f4f6 !important"
                      >
                        <v-row no-gutters align="center">
                          <v-col
                            cols="4"
                            sm="3"
                            class="text-body-2 font-weight-medium text-text-muted"
                            >12:30 - 13:30</v-col
                          >
                          <v-col
                            cols="8"
                            sm="9"
                            class="text-body-2 font-italic text-text-muted"
                            >{{ $t('event_page.lunch_break') }}</v-col
                          >
                        </v-row>
                      </v-list-item>
                      <v-list-item
                    ...
                    <!-- Day 2 -->
                    <div
                      class="bg-background-light px-6 py-4 d-flex justify-space-between align-center border-y border-opacity-100"
                      style="border-color: #e5e7eb !important"
                    >
                      <h3 class="text-subtitle-2 font-weight-bold mb-0">
                        {{ $t('event_page.day2') }}
...
// Zapewniamy dane jeśli wejście było z zewnątrz (SSR)
await useAsyncData('gddb-data-event-' + route.params.id, () =>
...
// Odliczanie (docelowo do wydarzenia jeśli istnieje data)
