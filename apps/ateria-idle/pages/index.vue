...
import { useAteriaGameStore } from '@ateria-idle/features/ateria-idle/core/model/game.store';
import { useAteriaResourcesStore } from '@ateria-idle/features/ateria-idle/core/model/resources.store';
import { useAteriaWarriorStore } from '@ateria-idle/features/ateria-idle/warrior/model/warrior.store';
import { useAteriaInventoryStore } from '@ateria-idle/features/ateria-idle/warrior/model/inventory.store';
import { useAteriaMerchantStore } from '@ateria-idle/features/ateria-idle/merchant/model/merchant.store';
import { useAteriaScientistStore } from '@ateria-idle/features/ateria-idle/scientist/model/scientist.store';
import type { OfflineReport } from '@ateria-idle/entities/ateria-idle/game';

// Components
import AteriaResourceBar from '@ateria-idle/features/ateria-idle/core/ui/ResourceBar.vue';
import AteriaWarriorPanel from '@ateria-idle/features/ateria-idle/warrior/ui/WarriorPanel.vue';
import AteriaEquipmentPanel from '@ateria-idle/features/ateria-idle/warrior/ui/EquipmentPanel.vue';
import AteriaDungeonPanel from '@ateria-idle/features/ateria-idle/warrior/ui/DungeonPanel.vue';
import AteriaSlayerPanel from '@ateria-idle/features/ateria-idle/warrior/ui/SlayerPanel.vue';
import AteriaLoadoutPanel from '@ateria-idle/features/ateria-idle/warrior/ui/LoadoutPanel.vue';
import AteriaMerchantPanel from '@ateria-idle/features/ateria-idle/merchant/ui/MerchantPanel.vue';
import AteriaCaravanPanel from '@ateria-idle/features/ateria-idle/merchant/ui/CaravanPanel.vue';
import AteriaScientistPanel from '@ateria-idle/features/ateria-idle/scientist/ui/ScientistPanel.vue';
import AteriaGolemPanel from '@ateria-idle/features/ateria-idle/scientist/ui/GolemPanel.vue';
import AteriaNotifications from '@ateria-idle/features/ateria-idle/core/ui/Notifications.vue';
import AteriaOfflineProgressModal from '@ateria-idle/features/ateria-idle/core/ui/OfflineProgressModal.vue';
import AteriaAchievementsPanel from '@ateria-idle/features/ateria-idle/core/ui/AchievementsPanel.vue';
import AteriaPrestigePanel from '@ateria-idle/features/ateria-idle/core/ui/PrestigePanel.vue';
import AteriaEventsPanel from '@ateria-idle/features/ateria-idle/core/ui/EventsPanel.vue';
import AteriaSettingsPanel from '@ateria-idle/features/ateria-idle/core/ui/SettingsPanel.vue';
import AteriaStatsPanel from '@ateria-idle/features/ateria-idle/core/ui/StatsPanel.vue';
import AteriaIntegrationPanel from '@ateria-idle/features/ateria-idle/core/ui/IntegrationPanel.vue';
import AteriaGatheringPanel from '@ateria-idle/features/ateria-idle/gathering/ui/GatheringPanel.vue';
import AteriaCraftingPanel from '@ateria-idle/features/ateria-idle/crafting/ui/CraftingPanel.vue';
import AteriaDiplomatPanel from '@ateria-idle/features/ateria-idle/diplomat/ui/DiplomatPanel.vue';
import AteriaDruidPanel from '@ateria-idle/features/ateria-idle/druid/ui/DruidPanel.vue';
import AteriaMysticPanel from '@ateria-idle/features/ateria-idle/mystic/ui/MysticPanel.vue';
import AteriaChefPanel from '@ateria-idle/features/ateria-idle/chef/ui/ChefPanel.vue';
import AteriaFishermanPanel from '@ateria-idle/features/ateria-idle/fisherman/ui/FishermanPanel.vue';
import AteriaWizardPanel from '@ateria-idle/features/ateria-idle/wizard/ui/WizardPanel.vue';
import AteriaExplorerPanel from '@ateria-idle/features/ateria-idle/explorer/ui/ExplorerPanel.vue';
import AteriaBardPanel from '@ateria-idle/features/ateria-idle/bard/ui/BardPanel.vue';
import AteriaAlchemistPanel from '@ateria-idle/features/ateria-idle/alchemist/ui/AlchemistPanel.vue';
import AteriaArchitectPanel from '@ateria-idle/features/ateria-idle/architect/ui/ArchitectPanel.vue';
import AteriaSpyPanel from '@ateria-idle/features/ateria-idle/spy/ui/SpyPanel.vue';
import AteriaTamerPanel from '@ateria-idle/features/ateria-idle/tamer/ui/TamerPanel.vue';
import AteriaPriestPanel from '@ateria-idle/features/ateria-idle/priest/ui/PriestPanel.vue';
import AteriaTownshipPanel from '@ateria-idle/features/ateria-idle/township/ui/TownshipPanel.vue';
import AteriaQuestsPanel from '@ateria-idle/features/ateria-idle/quests/ui/QuestsPanel.vue';
import AteriaWorldBossesPanel from '@ateria-idle/features/ateria-idle/world-bosses/ui/WorldBossesPanel.vue';
import AteriaSynergiesPanel from '@ateria-idle/features/ateria-idle/synergies/ui/SynergiesPanel.vue';
import AteriaExplorationPanel from '@ateria-idle/features/ateria-idle/exploration/ui/ExplorationPanel.vue';
import AteriaCodexPanel from '@ateria-idle/features/ateria-idle/codex/ui/CodexPanel.vue';
import AteriaReputationPanel from '@ateria-idle/features/ateria-idle/reputation/ui/ReputationPanel.vue';
import AteriaCalendarPanel from '@ateria-idle/features/ateria-idle/calendar/ui/CalendarPanel.vue';
import AteriaCompanionsPanel from '@ateria-idle/features/ateria-idle/companions/ui/CompanionsPanel.vue';
import AteriaMinigamesPanel from '@ateria-idle/features/ateria-idle/minigames/ui/MinigamesPanel.vue';
import { useAteriaAchievementsStore } from '@ateria-idle/features/ateria-idle/core/model/achievements.store';
import { useAteriaPrestigeStore } from '@ateria-idle/features/ateria-idle/core/model/prestige.store';
import { useAteriaEventsStore } from '@ateria-idle/features/ateria-idle/core/model/events.store';
import { useAteriaIntegrationStore } from '@ateria-idle/features/ateria-idle/core/model/integration.store';
import { useAteriaGatheringStore } from '@ateria-idle/features/ateria-idle/gathering/model/gathering.store';
import { useAteriaCraftingStore } from '@ateria-idle/features/ateria-idle/crafting/model/crafting.store';
import { useAteriaDiplomatStore } from '@ateria-idle/features/ateria-idle/diplomat/model/diplomat.store';
import { useAteriaDruidStore } from '@ateria-idle/features/ateria-idle/druid/model/druid.store';
import { useAteriaMysticStore } from '@ateria-idle/features/ateria-idle/mystic/model/mystic.store';
import { useAteriaChefStore } from '@ateria-idle/features/ateria-idle/chef/model/chef.store';
import { useAteriaFishermanStore } from '@ateria-idle/features/ateria-idle/fisherman/model/fisherman.store';
import { useAteriaWizardStore } from '@ateria-idle/features/ateria-idle/wizard/model/wizard.store';
import { useAteriaExplorerStore } from '@ateria-idle/features/ateria-idle/explorer/model/explorer.store';
import { useAteriaBardStore } from '@ateria-idle/features/ateria-idle/bard/model/bard.store';
import { useAteriaAlchemistStore } from '@ateria-idle/features/ateria-idle/alchemist/model/alchemist.store';
import { useAteriaArchitectStore } from '@ateria-idle/features/ateria-idle/architect/model/architect.store';
import { useAteriaSpyStore } from '@ateria-idle/features/ateria-idle/spy/model/spy.store';
import { useAteriaTamerStore } from '@ateria-idle/features/ateria-idle/tamer/model/tamer.store';
import { useAteriaPriestStore } from '@ateria-idle/features/ateria-idle/priest/model/priest.store';
import { useAteriaTownshipStore } from '@ateria-idle/features/ateria-idle/township/model/township.store';
import { useAteriaQuestsStore } from '@ateria-idle/features/ateria-idle/quests/model/quests.store';
import { useAteriaWorldBossesStore } from '@ateria-idle/features/ateria-idle/world-bosses/model/world-bosses.store';
import { useAteriaSynergiesStore } from '@ateria-idle/features/ateria-idle/synergies/model/synergies.store';
import { useAteriaExplorationStore } from '@ateria-idle/features/ateria-idle/exploration/model/exploration.store';
import { useAteriaCodexStore } from '@ateria-idle/features/ateria-idle/codex/model/codex.store';
import { useAteriaReputationStore } from '@ateria-idle/features/ateria-idle/reputation/model/reputation.store';
import { useAteriaCalendarStore } from '@ateria-idle/features/ateria-idle/calendar/model/calendar.store';
import { useAteriaCompanionsStore } from '@ateria-idle/features/ateria-idle/companions/model/companions.store';
import { useAteriaMinigamesStore } from '@ateria-idle/features/ateria-idle/minigames/model/minigames.store';
