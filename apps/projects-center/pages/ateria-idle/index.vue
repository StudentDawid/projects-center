...
import { useAteriaGameStore } from '@projects-center/features/ateria-idle/core/model/game.store';
import { useAteriaResourcesStore } from '@projects-center/features/ateria-idle/core/model/resources.store';
import { useAteriaWarriorStore } from '@projects-center/features/ateria-idle/warrior/model/warrior.store';
import { useAteriaInventoryStore } from '@projects-center/features/ateria-idle/warrior/model/inventory.store';
import { useAteriaMerchantStore } from '@projects-center/features/ateria-idle/merchant/model/merchant.store';
import { useAteriaScientistStore } from '@projects-center/features/ateria-idle/scientist/model/scientist.store';
import type { OfflineReport } from '@projects-center/entities/ateria-idle/game';

// Components
import AteriaResourceBar from '@projects-center/features/ateria-idle/core/ui/ResourceBar.vue';
import AteriaWarriorPanel from '@projects-center/features/ateria-idle/warrior/ui/WarriorPanel.vue';
import AteriaEquipmentPanel from '@projects-center/features/ateria-idle/warrior/ui/EquipmentPanel.vue';
import AteriaDungeonPanel from '@projects-center/features/ateria-idle/warrior/ui/DungeonPanel.vue';
import AteriaSlayerPanel from '@projects-center/features/ateria-idle/warrior/ui/SlayerPanel.vue';
import AteriaLoadoutPanel from '@projects-center/features/ateria-idle/warrior/ui/LoadoutPanel.vue';
import AteriaMerchantPanel from '@projects-center/features/ateria-idle/merchant/ui/MerchantPanel.vue';
import AteriaCaravanPanel from '@projects-center/features/ateria-idle/merchant/ui/CaravanPanel.vue';
import AteriaScientistPanel from '@projects-center/features/ateria-idle/scientist/ui/ScientistPanel.vue';
import AteriaGolemPanel from '@projects-center/features/ateria-idle/scientist/ui/GolemPanel.vue';
import AteriaNotifications from '@projects-center/features/ateria-idle/core/ui/Notifications.vue';
import AteriaOfflineProgressModal from '@projects-center/features/ateria-idle/core/ui/OfflineProgressModal.vue';
import AteriaAchievementsPanel from '@projects-center/features/ateria-idle/core/ui/AchievementsPanel.vue';
import AteriaPrestigePanel from '@projects-center/features/ateria-idle/core/ui/PrestigePanel.vue';
import AteriaEventsPanel from '@projects-center/features/ateria-idle/core/ui/EventsPanel.vue';
import AteriaSettingsPanel from '@projects-center/features/ateria-idle/core/ui/SettingsPanel.vue';
import AteriaStatsPanel from '@projects-center/features/ateria-idle/core/ui/StatsPanel.vue';
import AteriaIntegrationPanel from '@projects-center/features/ateria-idle/core/ui/IntegrationPanel.vue';
import AteriaGatheringPanel from '@projects-center/features/ateria-idle/gathering/ui/GatheringPanel.vue';
import AteriaCraftingPanel from '@projects-center/features/ateria-idle/crafting/ui/CraftingPanel.vue';
import AteriaDiplomatPanel from '@projects-center/features/ateria-idle/diplomat/ui/DiplomatPanel.vue';
import AteriaDruidPanel from '@projects-center/features/ateria-idle/druid/ui/DruidPanel.vue';
import AteriaMysticPanel from '@projects-center/features/ateria-idle/mystic/ui/MysticPanel.vue';
import AteriaChefPanel from '@projects-center/features/ateria-idle/chef/ui/ChefPanel.vue';
import AteriaFishermanPanel from '@projects-center/features/ateria-idle/fisherman/ui/FishermanPanel.vue';
import AteriaWizardPanel from '@projects-center/features/ateria-idle/wizard/ui/WizardPanel.vue';
import AteriaExplorerPanel from '@projects-center/features/ateria-idle/explorer/ui/ExplorerPanel.vue';
import AteriaBardPanel from '@projects-center/features/ateria-idle/bard/ui/BardPanel.vue';
import AteriaAlchemistPanel from '@projects-center/features/ateria-idle/alchemist/ui/AlchemistPanel.vue';
import AteriaArchitectPanel from '@projects-center/features/ateria-idle/architect/ui/ArchitectPanel.vue';
import AteriaSpyPanel from '@projects-center/features/ateria-idle/spy/ui/SpyPanel.vue';
import AteriaTamerPanel from '@projects-center/features/ateria-idle/tamer/ui/TamerPanel.vue';
import AteriaPriestPanel from '@projects-center/features/ateria-idle/priest/ui/PriestPanel.vue';
import AteriaTownshipPanel from '@projects-center/features/ateria-idle/township/ui/TownshipPanel.vue';
import AteriaQuestsPanel from '@projects-center/features/ateria-idle/quests/ui/QuestsPanel.vue';
import AteriaWorldBossesPanel from '@projects-center/features/ateria-idle/world-bosses/ui/WorldBossesPanel.vue';
import AteriaSynergiesPanel from '@projects-center/features/ateria-idle/synergies/ui/SynergiesPanel.vue';
import AteriaExplorationPanel from '@projects-center/features/ateria-idle/exploration/ui/ExplorationPanel.vue';
import AteriaCodexPanel from '@projects-center/features/ateria-idle/codex/ui/CodexPanel.vue';
import AteriaReputationPanel from '@projects-center/features/ateria-idle/reputation/ui/ReputationPanel.vue';
import AteriaCalendarPanel from '@projects-center/features/ateria-idle/calendar/ui/CalendarPanel.vue';
import AteriaCompanionsPanel from '@projects-center/features/ateria-idle/companions/ui/CompanionsPanel.vue';
import AteriaMinigamesPanel from '@projects-center/features/ateria-idle/minigames/ui/MinigamesPanel.vue';
import { useAteriaAchievementsStore } from '@projects-center/features/ateria-idle/core/model/achievements.store';
import { useAteriaPrestigeStore } from '@projects-center/features/ateria-idle/core/model/prestige.store';
import { useAteriaEventsStore } from '@projects-center/features/ateria-idle/core/model/events.store';
import { useAteriaIntegrationStore } from '@projects-center/features/ateria-idle/core/model/integration.store';
import { useAteriaGatheringStore } from '@projects-center/features/ateria-idle/gathering/model/gathering.store';
import { useAteriaCraftingStore } from '@projects-center/features/ateria-idle/crafting/model/crafting.store';
import { useAteriaDiplomatStore } from '@projects-center/features/ateria-idle/diplomat/model/diplomat.store';
import { useAteriaDruidStore } from '@projects-center/features/ateria-idle/druid/model/druid.store';
import { useAteriaMysticStore } from '@projects-center/features/ateria-idle/mystic/model/mystic.store';
import { useAteriaChefStore } from '@projects-center/features/ateria-idle/chef/model/chef.store';
import { useAteriaFishermanStore } from '@projects-center/features/ateria-idle/fisherman/model/fisherman.store';
import { useAteriaWizardStore } from '@projects-center/features/ateria-idle/wizard/model/wizard.store';
import { useAteriaExplorerStore } from '@projects-center/features/ateria-idle/explorer/model/explorer.store';
import { useAteriaBardStore } from '@projects-center/features/ateria-idle/bard/model/bard.store';
import { useAteriaAlchemistStore } from '@projects-center/features/ateria-idle/alchemist/model/alchemist.store';
import { useAteriaArchitectStore } from '@projects-center/features/ateria-idle/architect/model/architect.store';
import { useAteriaSpyStore } from '@projects-center/features/ateria-idle/spy/model/spy.store';
import { useAteriaTamerStore } from '@projects-center/features/ateria-idle/tamer/model/tamer.store';
import { useAteriaPriestStore } from '@projects-center/features/ateria-idle/priest/model/priest.store';
import { useAteriaTownshipStore } from '@projects-center/features/ateria-idle/township/model/township.store';
import { useAteriaQuestsStore } from '@projects-center/features/ateria-idle/quests/model/quests.store';
import { useAteriaWorldBossesStore } from '@projects-center/features/ateria-idle/world-bosses/model/world-bosses.store';
import { useAteriaSynergiesStore } from '@projects-center/features/ateria-idle/synergies/model/synergies.store';
import { useAteriaExplorationStore } from '@projects-center/features/ateria-idle/exploration/model/exploration.store';
import { useAteriaCodexStore } from '@projects-center/features/ateria-idle/codex/model/codex.store';
import { useAteriaReputationStore } from '@projects-center/features/ateria-idle/reputation/model/reputation.store';
import { useAteriaCalendarStore } from '@projects-center/features/ateria-idle/calendar/model/calendar.store';
import { useAteriaCompanionsStore } from '@projects-center/features/ateria-idle/companions/model/companions.store';
import { useAteriaMinigamesStore } from '@projects-center/features/ateria-idle/minigames/model/minigames.store';
