...
import { useAteriaGameStore } from '@libs/features/ateria-idle/core/model/game.store';
import { useAteriaResourcesStore } from '@libs/features/ateria-idle/core/model/resources.store';
import { useAteriaWarriorStore } from '@libs/features/ateria-idle/warrior/model/warrior.store';
import { useAteriaInventoryStore } from '@libs/features/ateria-idle/warrior/model/inventory.store';
import { useAteriaMerchantStore } from '@libs/features/ateria-idle/merchant/model/merchant.store';
import { useAteriaScientistStore } from '@libs/features/ateria-idle/scientist/model/scientist.store';
import type { OfflineReport } from '@libs/entities/ateria-idle/game';

// Components
import AteriaResourceBar from '@libs/features/ateria-idle/core/ui/ResourceBar.vue';
import AteriaWarriorPanel from '@libs/features/ateria-idle/warrior/ui/WarriorPanel.vue';
import AteriaEquipmentPanel from '@libs/features/ateria-idle/warrior/ui/EquipmentPanel.vue';
import AteriaDungeonPanel from '@libs/features/ateria-idle/warrior/ui/DungeonPanel.vue';
import AteriaSlayerPanel from '@libs/features/ateria-idle/warrior/ui/SlayerPanel.vue';
import AteriaLoadoutPanel from '@libs/features/ateria-idle/warrior/ui/LoadoutPanel.vue';
import AteriaMerchantPanel from '@libs/features/ateria-idle/merchant/ui/MerchantPanel.vue';
import AteriaCaravanPanel from '@libs/features/ateria-idle/merchant/ui/CaravanPanel.vue';
import AteriaScientistPanel from '@libs/features/ateria-idle/scientist/ui/ScientistPanel.vue';
import AteriaGolemPanel from '@libs/features/ateria-idle/scientist/ui/GolemPanel.vue';
import AteriaNotifications from '@libs/features/ateria-idle/core/ui/Notifications.vue';
import AteriaOfflineProgressModal from '@libs/features/ateria-idle/core/ui/OfflineProgressModal.vue';
import AteriaAchievementsPanel from '@libs/features/ateria-idle/core/ui/AchievementsPanel.vue';
import AteriaPrestigePanel from '@libs/features/ateria-idle/core/ui/PrestigePanel.vue';
import AteriaEventsPanel from '@libs/features/ateria-idle/core/ui/EventsPanel.vue';
import AteriaSettingsPanel from '@libs/features/ateria-idle/core/ui/SettingsPanel.vue';
import AteriaStatsPanel from '@libs/features/ateria-idle/core/ui/StatsPanel.vue';
import AteriaIntegrationPanel from '@libs/features/ateria-idle/core/ui/IntegrationPanel.vue';
import AteriaGatheringPanel from '@libs/features/ateria-idle/gathering/ui/GatheringPanel.vue';
import AteriaCraftingPanel from '@libs/features/ateria-idle/crafting/ui/CraftingPanel.vue';
import AteriaDiplomatPanel from '@libs/features/ateria-idle/diplomat/ui/DiplomatPanel.vue';
import AteriaDruidPanel from '@libs/features/ateria-idle/druid/ui/DruidPanel.vue';
import AteriaMysticPanel from '@libs/features/ateria-idle/mystic/ui/MysticPanel.vue';
import AteriaChefPanel from '@libs/features/ateria-idle/chef/ui/ChefPanel.vue';
import AteriaFishermanPanel from '@libs/features/ateria-idle/fisherman/ui/FishermanPanel.vue';
import AteriaWizardPanel from '@libs/features/ateria-idle/wizard/ui/WizardPanel.vue';
import AteriaExplorerPanel from '@libs/features/ateria-idle/explorer/ui/ExplorerPanel.vue';
import AteriaBardPanel from '@libs/features/ateria-idle/bard/ui/BardPanel.vue';
import AteriaAlchemistPanel from '@libs/features/ateria-idle/alchemist/ui/AlchemistPanel.vue';
import AteriaArchitectPanel from '@libs/features/ateria-idle/architect/ui/ArchitectPanel.vue';
import AteriaSpyPanel from '@libs/features/ateria-idle/spy/ui/SpyPanel.vue';
import AteriaTamerPanel from '@libs/features/ateria-idle/tamer/ui/TamerPanel.vue';
import AteriaPriestPanel from '@libs/features/ateria-idle/priest/ui/PriestPanel.vue';
import AteriaTownshipPanel from '@libs/features/ateria-idle/township/ui/TownshipPanel.vue';
import AteriaQuestsPanel from '@libs/features/ateria-idle/quests/ui/QuestsPanel.vue';
import AteriaWorldBossesPanel from '@libs/features/ateria-idle/world-bosses/ui/WorldBossesPanel.vue';
import AteriaSynergiesPanel from '@libs/features/ateria-idle/synergies/ui/SynergiesPanel.vue';
import AteriaExplorationPanel from '@libs/features/ateria-idle/exploration/ui/ExplorationPanel.vue';
import AteriaCodexPanel from '@libs/features/ateria-idle/codex/ui/CodexPanel.vue';
import AteriaReputationPanel from '@libs/features/ateria-idle/reputation/ui/ReputationPanel.vue';
import AteriaCalendarPanel from '@libs/features/ateria-idle/calendar/ui/CalendarPanel.vue';
import AteriaCompanionsPanel from '@libs/features/ateria-idle/companions/ui/CompanionsPanel.vue';
import AteriaMinigamesPanel from '@libs/features/ateria-idle/minigames/ui/MinigamesPanel.vue';
import { useAteriaAchievementsStore } from '@libs/features/ateria-idle/core/model/achievements.store';
import { useAteriaPrestigeStore } from '@libs/features/ateria-idle/core/model/prestige.store';
import { useAteriaEventsStore } from '@libs/features/ateria-idle/core/model/events.store';
import { useAteriaIntegrationStore } from '@libs/features/ateria-idle/core/model/integration.store';
import { useAteriaGatheringStore } from '@libs/features/ateria-idle/gathering/model/gathering.store';
import { useAteriaCraftingStore } from '@libs/features/ateria-idle/crafting/model/crafting.store';
import { useAteriaDiplomatStore } from '@libs/features/ateria-idle/diplomat/model/diplomat.store';
import { useAteriaDruidStore } from '@libs/features/ateria-idle/druid/model/druid.store';
import { useAteriaMysticStore } from '@libs/features/ateria-idle/mystic/model/mystic.store';
import { useAteriaChefStore } from '@libs/features/ateria-idle/chef/model/chef.store';
import { useAteriaFishermanStore } from '@libs/features/ateria-idle/fisherman/model/fisherman.store';
import { useAteriaWizardStore } from '@libs/features/ateria-idle/wizard/model/wizard.store';
import { useAteriaExplorerStore } from '@libs/features/ateria-idle/explorer/model/explorer.store';
import { useAteriaBardStore } from '@libs/features/ateria-idle/bard/model/bard.store';
import { useAteriaAlchemistStore } from '@libs/features/ateria-idle/alchemist/model/alchemist.store';
import { useAteriaArchitectStore } from '@libs/features/ateria-idle/architect/model/architect.store';
import { useAteriaSpyStore } from '@libs/features/ateria-idle/spy/model/spy.store';
import { useAteriaTamerStore } from '@libs/features/ateria-idle/tamer/model/tamer.store';
import { useAteriaPriestStore } from '@libs/features/ateria-idle/priest/model/priest.store';
import { useAteriaTownshipStore } from '@libs/features/ateria-idle/township/model/township.store';
import { useAteriaQuestsStore } from '@libs/features/ateria-idle/quests/model/quests.store';
import { useAteriaWorldBossesStore } from '@libs/features/ateria-idle/world-bosses/model/world-bosses.store';
import { useAteriaSynergiesStore } from '@libs/features/ateria-idle/synergies/model/synergies.store';
import { useAteriaExplorationStore } from '@libs/features/ateria-idle/exploration/model/exploration.store';
import { useAteriaCodexStore } from '@libs/features/ateria-idle/codex/model/codex.store';
import { useAteriaReputationStore } from '@libs/features/ateria-idle/reputation/model/reputation.store';
import { useAteriaCalendarStore } from '@libs/features/ateria-idle/calendar/model/calendar.store';
import { useAteriaCompanionsStore } from '@libs/features/ateria-idle/companions/model/companions.store';
import { useAteriaMinigamesStore } from '@libs/features/ateria-idle/minigames/model/minigames.store';
