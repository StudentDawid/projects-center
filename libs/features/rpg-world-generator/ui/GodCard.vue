...
import type { God, GodDomain, GodPersonality, GodPowerLevel, PantheonHierarchy } from '@libs/shared/world-generator/types/cosmology.types';
import {
...
} from '@libs/shared/world-generator/types/cosmology.types';
