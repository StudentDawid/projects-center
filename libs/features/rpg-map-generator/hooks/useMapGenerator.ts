...
import { getColorFromBiome, getColorFromHeightValue } from '@libs/shared/map-generator/utils/color-utils';
import { BiomeType } from '@libs/shared/map-generator/utils/biomes-generator';
import { generateVoronoiGrid, getGridPolygon } from '@libs/shared/map-generator/utils/voronoi-grid-generator';
import { createHeightmapGenerator } from '@libs/shared/map-generator/utils/heightmap-generator';
import { markupGrid } from '@libs/shared/map-generator/utils/features-generator';
import {
  addLakesInDeepDepressions,
  openNearSeaLakes,
} from '@libs/shared/map-generator/utils/lakes-generator';
import { generateOceanLayers } from '@libs/shared/map-generator/utils/ocean-layers';
import { defineMapSize, calculateMapCoordinates } from '@libs/shared/map-generator/utils/map-coordinates';
import {
  calculateTemperatures,
  generatePrecipitation,
  type TemperatureOptions,
  type PrecipitationOptions,
} from '@libs/shared/map-generator/utils/climate-generator';
import { reGraph, getPackPolygon } from '@libs/shared/map-generator/utils/pack-generator';
import { markupPack, defineFeatureGroups } from '@libs/shared/map-generator/utils/pack-features';
import { createDefaultRuler } from '@libs/shared/map-generator/utils/ruler-generator';
import { generateRivers, type RiversOptions } from '@libs/shared/map-generator/utils/rivers-generator';
import { defineBiomes } from '@libs/shared/map-generator/utils/biomes-generator';
import type { Grid } from '@libs/shared/map-generator/types/grid.types';
import type { Pack, Ruler } from '@libs/shared/map-generator/types/pack.types';
import type { HeightmapOptions } from '@libs/shared/map-generator/types/heightmap.types';
import type { LakesGenerationOptions } from '@libs/shared/map-generator/utils/lakes-generator';
import type { OceanLayersOptions } from '@libs/shared/map-generator/utils/ocean-layers';
...
import { applyGraphSize } from '@libs/shared/map-generator/utils/graph-size';
// Import funkcji randomizacji opcji
import { randomizeOptions } from '@libs/shared/map-generator/utils/randomize-options';
// Import funkcji regeneracji gridu
import { shouldRegenerateGrid } from '@libs/shared/map-generator/utils/grid-regeneration';
