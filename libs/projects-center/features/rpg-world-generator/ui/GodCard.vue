...
import type { God, GodDomain, GodPersonality, GodPowerLevel, PantheonHierarchy } from '@projects-center/shared/world-generator/types/cosmology.types';
import {
...
} from '@projects-center/shared/world-generator/types/cosmology.types';
