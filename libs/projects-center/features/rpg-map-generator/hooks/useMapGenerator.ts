...
import { getColorFromBiome, getColorFromHeightValue } from '@projects-center/shared/map-generator/utils/color-utils';
import { BiomeType } from '@projects-center/shared/map-generator/utils/biomes-generator';
import { generateVoronoiGrid, getGridPolygon } from '@projects-center/shared/map-generator/utils/voronoi-grid-generator';
import { createHeightmapGenerator } from '@projects-center/shared/map-generator/utils/heightmap-generator';
import { markupGrid } from '@projects-center/shared/map-generator/utils/features-generator';
import {
  addLakesInDeepDepressions,
  openNearSeaLakes,
} from '@projects-center/shared/map-generator/utils/lakes-generator';
import { generateOceanLayers } from '@projects-center/shared/map-generator/utils/ocean-layers';
import { defineMapSize, calculateMapCoordinates } from '@projects-center/shared/map-generator/utils/map-coordinates';
import {
  calculateTemperatures,
  generatePrecipitation,
  type TemperatureOptions,
  type PrecipitationOptions,
} from '@projects-center/shared/map-generator/utils/climate-generator';
import { reGraph, getPackPolygon } from '@projects-center/shared/map-generator/utils/pack-generator';
import { markupPack, defineFeatureGroups } from '@projects-center/shared/map-generator/utils/pack-features';
import { createDefaultRuler } from '@projects-center/shared/map-generator/utils/ruler-generator';
import { generateRivers, type RiversOptions } from '@projects-center/shared/map-generator/utils/rivers-generator';
import { defineBiomes } from '@projects-center/shared/map-generator/utils/biomes-generator';
import type { Grid } from '@projects-center/shared/map-generator/types/grid.types';
import type { Pack, Ruler } from '@projects-center/shared/map-generator/types/pack.types';
import type { HeightmapOptions } from '@projects-center/shared/map-generator/types/heightmap.types';
import type { LakesGenerationOptions } from '@projects-center/shared/map-generator/utils/lakes-generator';
import type { OceanLayersOptions } from '@projects-center/shared/map-generator/utils/ocean-layers';

// Import funkcji zarządzania seed
import { setSeed } from '@projects-center/shared/map-generator/utils/seed-manager';
// Import funkcji zarządzania rozmiarem grafu
import { applyGraphSize } from '@projects-center/shared/map-generator/utils/graph-size';
// Import funkcji randomizacji opcji
import { randomizeOptions } from '@projects-center/shared/map-generator/utils/randomize-options';
// Import funkcji regeneracji gridu
import { shouldRegenerateGrid } from '@projects-center/shared/map-generator/utils/grid-regeneration';
