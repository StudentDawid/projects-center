...
import type { LootDrop, BiomeId, ItemRarity } from '@projects-center/entities/ateria-idle/warrior';
import type { FoodItem } from './food.data';
import { FOODS } from './food.data';
import { ALL_EQUIPMENT } from './equipment.data';
import type { Equipment } from '@projects-center/entities/ateria-idle/warrior';
