...
import { bn, Decimal, formatNumber } from '@projects-center/shared/lib/big-number';
import type { Resource, ResourceId, Resources } from '@projects-center/entities/ateria-idle/game';
