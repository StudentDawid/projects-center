/**
 * Szablony heightmap
 * Szablony heightmap z instrukcjami generowania
 */

export interface HeightmapTemplateData {
  id: string;
  name: string;
  template: string; // Steps as string separated by newlines
  probability: number;
}

/**
 * Szablony heightmap z ich krokami generowania
 */
export const heightmapTemplates: Record<string, HeightmapTemplateData> = {
  volcano: {
    id: 'volcano',
    name: 'Volcano',
    probability: 3,
