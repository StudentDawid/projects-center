...
import type { God, GodDomain, GodPersonality, GodPowerLevel, PantheonHierarchy } from '@rpg-tools/shared/world-generator/types/cosmology.types';
import {
...
} from '@rpg-tools/shared/world-generator/types/cosmology.types';
