...
import {
  ...
  openNearSeaLakes,
} from '~/shared/map-generator/utils/lakes-generator';
import { generateOceanLayers } from '~/shared/map-generator/utils/ocean-layers';
import { defineMapSize, calculateMapCoordinates } from '~/shared/map-generator/utils/map-coordinates';
import {
  calculateTemperatures,
  generatePrecipitation,
  type TemperatureOptions,
  type PrecipitationOptions,
} from '~/shared/map-generator/utils/climate-generator';
import { reGraph, getPackPolygon } from '~/shared/map-generator/utils/pack-generator';
import { markupPack, defineFeatureGroups } from '~/shared/map-generator/utils/pack-features';
import { createDefaultRuler } from '~/shared/map-generator/utils/ruler-generator';
import { generateRivers, type RiversOptions } from '~/shared/map-generator/utils/rivers-generator';
import { defineBiomes } from '~/shared/map-generator/utils/biomes-generator';
import type { Grid } from '~/shared/map-generator/types/grid.types';
import type { Pack, Ruler } from '~/shared/map-generator/types/pack.types';
import type { HeightmapOptions } from '~/shared/map-generator/types/heightmap.types';
import type { LakesGenerationOptions } from '~/shared/map-generator/utils/lakes-generator';
import type { OceanLayersOptions } from '~/shared/map-generator/utils/ocean-layers';

// Import funkcji zarządzania seed
import { setSeed } from '~/shared/map-generator/utils/seed-manager';
// Import funkcji zarządzania rozmiarem grafu
import { applyGraphSize } from '~/shared/map-generator/utils/graph-size';
// Import funkcji randomizacji opcji
import { randomizeOptions } from '~/shared/map-generator/utils/randomize-options';
// Import funkcji regeneracji gridu
import { shouldRegenerateGrid } from '~/shared/map-generator/utils/grid-regeneration';
